...
const DeliveryDetailsModal = ({ isOpen, onClose, delivery }) => {
    ...
    const timeline = [
        ...
        { status: 'picked_up', label: 'Order Picked Up', time: delivery.pickedUpAt, icon: Package, color: 'text-bakery-accent', bg: 'bg-bakery-bg' },
        { status: 'in_transit', label: 'Out for Delivery', time: delivery.pickedUpAt, icon: Navigation, color: 'text-orange-500', bg: 'bg-orange-50' },
        { status: 'delivered', label: 'Delivered', time: delivery.deliveredAt, icon: CheckCircle2, color: 'text-bakery-accent', bg: 'bg-bakery-bg' },
                        ...
                        <div>
                            <div className="flex items-center gap-3">
                                ...
                                {delivery.orderId?.brand && (
                                    <span className={`px-3 py-1 rounded-md text-[8px] font-black uppercase tracking-widest border ${delivery.orderId.brand === 'littleh' ? 'bg-pink-50 text-pink-700 border-pink-100' : 'bg-bakery-bg text-bakery-primary border-bakery-light'
                                        }`}>
                ...
                <div className="flex-1 overflow-y-auto p-10">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                                        ...
                                        {isValidCoord(riderPos) && (
                                            <>
                                                <Marker position={riderPos} icon={riderIcon}>
                                                    <Popup>
                                                        <div className="text-[10px] font-black text-gray-900 uppercase text-bakery-primary">Rider Location</div>
                                                    </Popup>
                                                </Marker>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="p-8 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="p-3 bg-bakery-primary text-white rounded-xl">
                        ...
                        <div className="lg:col-span-4 space-y-8">
                                        ...
                                        {timeline.map((event, index) => (
                                            <div key={index} className="flex gap-6 items-start relative group">
                                                <div className="bg-white z-10 mt-1">
                                                    <div className={`w-8 h-8 rounded-xl border-4 border-white flex items-center justify-center shadow-sm transition-all ${index === timeline.length - 1 ? 'bg-bakery-primary ring-8 ring-bakery-bg scale-110' : 'bg-gray-100'
                                                        }`}>
                            ...
                            {/* Efficiency Info */}
                            <div className="bg-bakery-primary rounded-[2.5rem] p-10 space-y-6 shadow-2xl shadow-bakery-light/50">
                                <div className="flex items-center gap-3">
                                ...
                                <div className="pt-6 border-t border-white/10 space-y-1">
                                    ...
                                    <p className="text-[10px] font-black text-bakery-accent uppercase tracking-widest">ON_TIME</p>
                                </div>
                            </div>
                        </div>
                    </div>
