        ...
        <div className="fixed inset-0 bg-bakery-primary/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden border border-gray-100 flex flex-col">
                    ...
                    <div className="flex gap-8">
                        <button
                            ...
                            className={`px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] transition-all relative ${activeTab === 'details'
                                ? 'text-bakery-primary'
                                : 'text-gray-400 hover:text-bakery-primary'
                                }`}
                        >
                            Rider Details
                            {activeTab === 'details' && <div className="absolute bottom-0 left-0 right-0 h-1 bg-bakery-primary rounded-full" />}
                        </button>
                        <button
                        ...
                        >
                            Customer Reviews
                            {activeTab === 'reviews' && <div className="absolute bottom-0 left-0 right-0 h-1 bg-bakery-primary rounded-full" />}
                        </button>
                    </div>
                </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-4 col-span-1 md:col-span-2">
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                        {[
                                            ...
                                            { label: 'Net Earnings', value: `₹${rider.totalEarnings || 0}`, icon: CreditCard, color: 'text-bakery-primary', bg: 'bg-bakery-bg' },
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 space-y-6 shadow-sm hover:border-bakery-light transition-colors">
                                ...
                                <div className="space-y-4 col-span-1 md:col-span-2">
                                    <div className="flex items-center gap-3 px-2">
                                        <div className="p-2 bg-bakery-bg rounded-lg">
                                            <FileText className="w-4 h-4 text-bakery-primary" />
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div className="bg-white border border-gray-100 rounded-[2rem] p-6 shadow-sm hover:shadow-md transition-shadow">
                                            ...
                                            {rider.licensePhoto && (
                                                <a href={rider.licensePhoto} target="_blank" rel="noopener noreferrer" className="block w-full text-center py-3 bg-bakery-bg text-[10px] font-black text-bakery-primary uppercase tracking-widest rounded-xl hover:bg-bakery-primary hover:text-white transition-all">VIEW PHOTO</a>
                                            )}
                                        </div>
                                        ...
                                        <div className="bg-white border border-gray-100 rounded-[2rem] p-6 shadow-sm hover:shadow-md transition-shadow">
                                            ...
                                            {rider.aadharPhoto && (
                                                <a href={rider.aadharPhoto} target="_blank" rel="noopener noreferrer" className="block w-full text-center py-3 bg-bakery-bg text-[10px] font-black text-bakery-primary uppercase tracking-widest rounded-xl hover:bg-bakery-primary hover:text-white transition-all">VIEW PHOTO</a>
                                            )}
                                        </div>
                                        ...
                                        <div className="bg-white border border-gray-100 rounded-[2rem] p-6 shadow-sm hover:shadow-md transition-shadow">
                                            ...
                                            {rider.panPhoto && (
                                                <a href={rider.panPhoto} target="_blank" rel="noopener noreferrer" className="block w-full text-center py-3 bg-bakery-bg text-[10px] font-black text-bakery-primary uppercase tracking-widest rounded-xl hover:bg-bakery-primary hover:text-white transition-all">VIEW PHOTO</a>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-8 col-span-1 md:col-span-2">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-3 px-2">
                                                <div className="p-2 bg-bakery-bg rounded-lg">
                                                    <CreditCard className="w-4 h-4 text-bakery-primary" />
                                                </div>
                            ...
                            <div className="flex gap-4 pt-4">
                                {!rider.isApproved && (
                                    <>
                                        <button
                                            ...
                                            className="flex-1 py-5 bg-bakery-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary transition-all shadow-xl shadow-bakery-light"
                                        >
                                            Approve Rider
                                        </button>
                                        <button
                                ...
                                {rider.isApproved && (
                                    <button
                                        ...
                                        className={`flex-1 py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-xl ${rider.isActive ? 'bg-orange-600 text-white shadow-orange-100 hover:bg-orange-700' : 'bg-bakery-primary text-white shadow-bakery-light hover:bg-bakery-primary'}`}
                                    >
                        ...
                        <div className="space-y-6">
                            {loadingReviews ? (
                                <div className="text-center py-20 bg-gray-50/50 rounded-[2.5rem] border border-gray-50">
                                    <div className="animate-spin rounded-full h-12 w-12 border-4 border-bakery-primary border-t-transparent mx-auto"></div>
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    {reviews.map((review) => (
                                        <div key={review._id} className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:border-bakery-accent transition-all">
                                            <div className="flex justify-between items-start mb-6">
                                                <div className="flex gap-4">
                                                    <div className="w-12 h-12 bg-bakery-primary text-white rounded-xl flex items-center justify-center font-black text-lg">
                ...
                <div className="p-8 bg-gray-50/50 border-t border-gray-50">
                    <button
                        onClick={onClose}
                        className="w-full py-5 bg-bakery-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary transition-all shadow-xl shadow-bakery-light"
                    >
                        Close Details
                    </button>
                </div>
