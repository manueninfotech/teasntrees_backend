        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-bakery-primary/40 backdrop-blur-sm">
            <div className="bg-white rounded-[2.5rem] w-full max-w-2xl overflow-hidden shadow-2xl border border-gray-100 flex flex-col max-h-[90vh] relative z-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            {cart.items.map((item, index) => (
                                <div key={index} className="flex items-center gap-6 p-6 bg-white border border-gray-100 rounded-[2rem] hover:border-bakery-primary transition-all group shadow-sm">
                                    <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center font-black text-gray-300 group-hover:bg-bakery-primary group-hover:text-white transition-all text-xs">
                ...
                <div className="p-10 border-t border-gray-50 bg-gray-50/50 flex gap-6">
                    <button
                        onClick={onClose}
                        className="flex-1 px-8 py-5 border-2 border-gray-100 bg-white rounded-2xl text-[10px] font-black text-gray-400 hover:text-gray-900 hover:border-bakery-primary transition-all uppercase tracking-widest"
                    >
                        Close
                    </button>
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex-[2] px-8 py-5 bg-bakery-primary text-white rounded-2xl text-[10px] font-black transition-all shadow-xl shadow-bakery-light uppercase tracking-widest flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95 hover:bg-bakery-primary"
                    >
