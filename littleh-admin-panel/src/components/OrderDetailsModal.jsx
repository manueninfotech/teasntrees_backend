            ...
            <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-y-auto border border-gray-100">
                ...
                <div className="p-8 space-y-8">
                            ...
                            {order.status !== 'delivered' && order.status !== 'cancelled' && (
                                <>
                                    <button
                                        ...
                                        className="px-6 py-3 bg-white border border-gray-100 text-gray-900 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary hover:text-white transition-all shadow-sm"
                                    >
                                        Update Status
                                    </button>
                                    <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 px-2">
                                <div className="p-2 bg-bakery-bg rounded-lg">
                                    <User className="w-4 h-4 text-bakery-primary" />
                                </div>
                                <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Customer Info</h3>
                            </div>
                            <div className="bg-white border border-gray-100 rounded-[2rem] p-6 space-y-4 shadow-sm hover:border-bakery-light transition-colors">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 px-2">
                                <div className="p-2 bg-bakery-bg rounded-lg">
                                    <MapPin className="w-4 h-4 text-bakery-primary" />
                                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white border border-gray-100 rounded-[2.5rem] overflow-hidden shadow-sm hover:border-bakery-light transition-colors">
                            <div className="divide-y divide-gray-50">
                                {order.items?.map((item, index) => (
                                    <div key={index} className="flex items-center gap-6 p-6 hover:bg-bakery-bg transition-colors group">
                                        {item.product?.image && (
                                            <img
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white border border-gray-100 rounded-[2rem] p-8 space-y-4 shadow-sm hover:border-bakery-light transition-colors">
                                ...
                                <div className="mt-6 pt-6 border-t border-gray-50 space-y-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <span className={`text-[10px] font-black uppercase tracking-widest ${order.paymentStatus === 'paid' ? 'text-bakery-primary' : order.paymentStatus === 'refunded' ? 'text-red-600' : 'text-orange-600'}`}>
                                                {order.paymentStatus}
                                            </span>
                                            {order.status !== 'cancelled' && (
                                                <button
                                                    onClick={() => setShowPaymentUpdate(true)}
                                                    className="px-3 py-1 bg-gray-50 text-gray-400 rounded-lg text-[8px] font-black uppercase hover:bg-bakery-primary hover:text-white transition-all"
                                                >
                                                    Update
                                                </button>
                                            )}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white border border-gray-100 rounded-[2rem] p-8 space-y-6 shadow-sm hover:border-bakery-light transition-colors">
                                {order.riderId ? (
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                            ...
                                            {order.riderEarning && (
                                                <div className="col-span-2">
                                                    ...
                                                    <p className="text-xl font-black text-bakery-primary tracking-tight">₹{order.riderEarning}</p>
                                                </div>
                                            )}
                                        </div>
                                        {order.status !== 'delivered' && order.status !== 'cancelled' && (
                                            <button
                                                ...
                                                className="w-full py-4 bg-gray-50 text-gray-400 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary hover:text-white transition-all"
                                            >
                                                Change Rider
                                            </button>
                                        )}
                                    ...
                                    <div className="py-6 text-center space-y-4">
                                        ...
                                        {order.status !== 'delivered' && order.status !== 'cancelled' && (
                                            <button
                                                onClick={() => setShowRiderAssignment(true)}
                                                className="w-full py-4 bg-bakery-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary transition-all shadow-xl shadow-bakery-light"
                                            >
                                                Assign Rider
                                            </button>
                                        )}
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 px-2">
                            <div className="p-2 bg-bakery-bg rounded-lg">
                                <Calendar className="w-4 h-4 text-bakery-primary" />
                            </div>
                            <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Order Timeline</h3>
                        </div>
                        <div className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:border-bakery-light transition-colors">
                    ...
                    <div className="fixed inset-0 bg-bakery-primary/40 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
                        <div className="bg-white rounded-[2rem] p-8 w-full max-w-md shadow-2xl border border-gray-100">
                            ...
                            <select
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 text-sm font-black uppercase tracking-widest focus:ring-2 focus:ring-bakery-primary mb-6 focus:bg-white"
                            >
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-6 py-4 bg-bakery-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary disabled:opacity-50 transition-all shadow-xl shadow-bakery-light"
                                >
                    ...
                    <div className="fixed inset-0 bg-bakery-primary/40 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
                        <div className="bg-white rounded-[2.5rem] p-10 w-full max-w-lg shadow-2xl border border-gray-100">
                                    ...
                                    <>
                                        <button
                                            ...
                                            className={`w-full mb-6 px-8 py-5 rounded-2xl font-black uppercase text-[10px] tracking-widest flex items-center justify-center gap-3 transition-all ${!hasCoordinates
                                                ...
                                                : 'bg-bakery-primary text-white hover:bg-bakery-primary shadow-xl shadow-bakery-light'
                                                } disabled:opacity-50`}
                                        >
                            ...
                            <select
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 text-sm font-black uppercase tracking-widest focus:ring-2 focus:ring-bakery-primary mb-2 focus:bg-white"
