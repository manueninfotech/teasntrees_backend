            ...
            <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden border border-gray-100 flex flex-col">
                ...
                <div className="border-b border-gray-50 px-8 bg-gray-50/30">
                    <div className="flex gap-8">
                        ...
                        >
                            General Info
                            {activeTab === 'info' && <div className="absolute bottom-0 left-0 right-0 h-1 bg-bakery-primary rounded-full" />}
                        </button>
                        <button
                        ...
                        >
                            ...
                            {activeTab === 'orders' && <div className="absolute bottom-0 left-0 right-0 h-1 bg-bakery-primary rounded-full" />}
                        </button>
                    </div>
                </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                {[
                                    ...
                                    { label: 'Completed', value: stats.completedOrders || 0, icon: CheckCircle, color: 'text-bakery-primary', bg: 'bg-bakery-bg' },
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-4">
                                        {customerDetails.addresses?.map((address, index) => (
                                            <div key={index} className="bg-white border border-gray-100 rounded-[2rem] p-6 shadow-sm hover:border-bakery-primary transition-colors group">
                                                <div className="flex items-center justify-between mb-4">
                                                    <p className="text-[10px] font-black text-gray-900 uppercase tracking-widest">{address.label || 'SITE'}</p>
                                                    {address.isDefault && (
                                                        <span className="px-2 py-1 text-[8px] font-black uppercase tracking-widest rounded-md bg-bakery-primary text-white">
                                                            Primary
                                                        </span>
                                                    )}
                                                </div>
                        ...
                        <div className="space-y-4">
                            {loading ? (
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    {orders.map((order) => (
                                        <div key={order._id} className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:border-bakery-primary transition-all group">
                                            ...
                                            <div className="grid grid-cols-3 gap-8">
                                                ...
                                                <div>
                                                    ...
                                                    <span className={`text-[10px] font-black uppercase tracking-widest ${order.paymentStatus === 'paid' ? 'text-bakery-primary' : 'text-orange-600'}`}>
                                                        {order.paymentStatus}
                                                    </span>
                                                </div>
                                            </div>
