...
const LogDetailsModal = ({ log, isOpen, onClose }) => {
    ...
    const getActionColor = (action) => {
        switch (action) {
            ...
            case 'login': return 'text-bakery-primary bg-bakery-light';
            case 'activate': return 'text-bakery-primary bg-bakery-light';
                ...
                <div className="p-10 overflow-y-auto flex-1 space-y-10">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-900 rounded-[2.5rem] p-8 overflow-x-auto max-h-80 shadow-2xl relative group">
                            ...
                            <pre className="text-[10px] font-mono text-bakery-accent leading-relaxed scrollbar-hide">
                                {(() => {
