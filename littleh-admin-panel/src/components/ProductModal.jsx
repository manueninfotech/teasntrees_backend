                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="col-span-2 space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl py-4 px-6 text-sm font-black uppercase tracking-widest placeholder:text-gray-300 focus:ring-2 focus:ring-bakery-primary focus:bg-white transition-all"
                        ...
                        <div className="col-span-2 space-y-2">
                            ...
                            <textarea
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl py-4 px-6 text-sm font-black uppercase tracking-widest placeholder:text-gray-300 focus:ring-2 focus:ring-bakery-primary focus:bg-white transition-all min-h-[100px] resize-none"
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl py-4 px-6 text-sm font-black uppercase tracking-widest focus:ring-2 focus:ring-bakery-primary focus:bg-white transition-all"
                                required
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl py-4 px-6 text-sm font-black uppercase tracking-widest focus:ring-2 focus:ring-bakery-primary focus:bg-white transition-all appearance-none"
                                required
                            >
                                    ...
                                    return (
                                        <label
                                            ...
                                            className={`flex items-center justify-center gap-2 p-4 rounded-2xl border transition-all cursor-pointer ${isSelected
                                                ? 'bg-bakery-primary border-bakery-primary text-white shadow-lg shadow-bakery-accent'
                            ...
                            <div className="space-y-4">
                                ...
                                {(imagePreview || formData.image) && (
                                    <div className="relative w-full h-56 bg-gray-50 rounded-[2rem] overflow-hidden border border-gray-100 group">
                                        ...
                                        <button
                                            ...
                                            className="absolute top-4 right-4 p-3 bg-red-600 text-white rounded-xl hover:bg-bakery-primary transition-all shadow-xl"
                                        >
                                            <X className="w-4 h-4" />
                                        </button>
                                    </div>
                                ...
                                <label className="flex flex-col items-center justify-center w-full h-40 bg-gray-50 border-2 border-dashed border-gray-200 rounded-[2rem] cursor-pointer hover:bg-gray-100 transition-all group">
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] group-hover:text-bakery-primary">
                                            Click to Upload
                                        </p>
                    ...
                    <div className="flex gap-4 pt-6">
                        ...
                        <button
                            ...
                            className="flex-1 py-5 bg-bakery-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary disabled:opacity-50 transition-all shadow-xl shadow-bakery-light"
                        >
