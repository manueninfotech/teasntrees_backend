        ...
        <div className="space-y-8 max-w-5xl mx-auto flex flex-col relative pb-10">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm flex items-start gap-6">
                <div className="p-3 bg-gray-50 rounded-xl">
                    <AlertCircle className="w-6 h-6 text-bakery-primary" />
                </div>
                <div>
                    <h4 className="text-xs font-black text-gray-900 uppercase tracking-widest mb-2">How to use</h4>
                    <p className="text-sm text-gray-500 font-medium leading-relaxed">
                        Use the <strong className="text-bakery-primary">Polygon Tool</strong> (Top-Right) to draw new zones.
                        The <strong className="text-bakery-primary">Dotted Circle</strong> shows your standard delivery range. You can add extra charges for zones outside this area.
                    </p>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md p-10 animate-in fade-in zoom-in duration-200 border border-gray-100">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] px-2">Zone Name</label>
                                <input
                                    type="text"
                                    placeholder="e.g. North Area"
                                    value={zoneForm.name}
                                    onChange={(e) => setZoneForm({ ...zoneForm, name: e.target.value })}
                                    className="w-full px-6 py-4 rounded-[1.5rem] border border-gray-100 bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-bakery-primary focus:border-bakery-primary transition-all font-black text-sm uppercase placeholder:text-gray-300"
                                    autoFocus
                                />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="flex gap-4 mt-10">
                            ...
                            <button
                                ...
                                className="flex-1 px-6 py-4 bg-bakery-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-bakery-primary transition-all shadow-lg shadow-bakery-light disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-95"
                            >
                                Create Zone
                            </button>
                        </div>
