    ...
    if (loading && !profile.name) {
        return (
            <div className="flex justify-center items-center h-screen bg-gray-50">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-bakery-primary"></div>
            </div>
        );
    }
                    ...
                    <div className="bg-white rounded-[3rem] shadow-sm border border-gray-100 p-8 text-center">
                        ...
                        <div className="mt-8 pt-8 border-t border-gray-50 flex flex-col gap-4 text-[10px] font-black uppercase tracking-widest">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-bakery-primary">Active</span>
                            </div>
                            <div className="flex items-center justify-between">
                ...
                <div className="md:col-span-2">
                    <div className="bg-white rounded-[3rem] shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            {successMessage && (
                                <div className="p-4 bg-bakery-bg text-bakery-primary rounded-lg flex items-center gap-2 text-sm">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-10 pr-4 py-2 border rounded-lg outline-none transition-all ${isEditing
                                                ? 'border-gray-300 focus:ring-2 focus:ring-bakery-primary focus:border-bakery-bg0'
                            ...
                            {isEditing && (
                                <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={saving}
                                        className="flex items-center gap-2 px-6 py-2 bg-bakery-primary text-white rounded-lg hover:bg-bakery-primary transition-colors font-medium disabled:opacity-70 disabled:cursor-not-allowed shadow-sm"
                                    >
                                        {saving ? (
                                            <>
