                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-black text-bakery-primary uppercase">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                <span className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-tight ${product.isAvailable ? 'bg-bakery-bg text-bakery-primary' : 'bg-red-50 text-red-600'}`}>
