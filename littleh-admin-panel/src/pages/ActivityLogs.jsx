...
const ActivityLogs = () => {
    ...
    const getActionBadge = (action) => {
        const styles = {
            create: 'bg-bakery-bg text-bakery-primary border-bakery-light',
            update: 'bg-blue-50 text-blue-700 border-blue-100',
            delete: 'bg-red-50 text-red-700 border-red-100',
            login: 'bg-bakery-bg text-bakery-primary border-bakery-light',
            activate: 'bg-bakery-bg text-bakery-primary border-bakery-light',
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full border ${isConnected ? 'bg-bakery-bg border-bakery-accent text-bakery-primary' : 'bg-red-50 border-red-200 text-red-700'}`}>
                            <div className={`w-2 h-2 rounded-full ${isConnected ? 'bg-bakery-bg animate-pulse' : 'bg-red-500'}`} />
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <RefreshCw className={`w-5 h-5 ${loading ? 'animate-spin text-bakery-primary' : 'text-gray-400'}`} />
                    </button>
                    <button
                        onClick={handleExport}
                        className="flex items-center gap-2 px-6 py-3 bg-bakery-primary rounded-2xl text-[10px] font-black uppercase text-white hover:bg-bakery-primary transition-all shadow-lg shadow-bakery-light hover:-translate-y-1"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
                    <div className="space-y-1.5">
                        <select
                            ...
                            className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-xs font-black uppercase outline-none focus:bg-white focus:border-bakery-accent transition-all text-gray-600"
                        >
                    ...
                    <div className="space-y-1.5">
                        <input
                            ...
                            onChange={handleFilterChange}
                            className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-xs font-bold outline-none focus:bg-white focus:border-bakery-accent transition-all text-gray-600"
                        />
                    </div>
