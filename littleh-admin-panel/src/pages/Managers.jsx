                        ...
                        {displayData.map(manager => (
                            <div key={manager._id} className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-6 hover:shadow-xl transition-all group">
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <span className={`px-2 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest ${manager.isApproved === true ? 'bg-bakery-light text-bakery-primary' : manager.isApproved === false ? 'bg-red-100 text-red-700' : 'bg-orange-100 text-orange-700'}`}>
                                ...
                                <div className="flex gap-2">
                                    {manager.isApproved === null ? (
                                        <>
                                            ...
                                            <button onClick={() => handleApprove(manager)} className="flex-1 bg-bakery-primary text-white py-3 rounded-2xl text-[10px] font-black uppercase hover:bg-bakery-primary">Approve</button>
                                        ...
                                        <>
                                            ...
                                            {manager.isApproved === true && (
                                                <button onClick={() => handleToggleStatus(manager)} className={`flex-1 py-3 rounded-2xl text-[10px] font-black uppercase border transition-all ${manager.isActive ? 'hover:bg-black hover:text-white border-gray-100' : 'bg-bakery-primary text-white hover:bg-bakery-primary'}`}>{manager.isActive ? 'Deactivate' : 'Activate'}</button>
                                            )}
