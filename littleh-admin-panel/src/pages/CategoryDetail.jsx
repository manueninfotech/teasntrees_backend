    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-96">
                <div className="w-12 h-12 border-4 border-bakery-primary border-t-transparent rounded-full animate-spin"></div>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Stats Card */}
                <div className="bg-gradient-to-br from-bakery-bg to-bakery-light rounded-xl shadow-sm border border-bakery-accent p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                {productsLoading ? (
                    <div className="flex items-center justify-center h-40">
                        <div className="w-8 h-8 border-4 border-bakery-primary border-t-transparent rounded-full animate-spin"></div>
                    </div>
                ) : products.length > 0 ? (
                            ...
                            >
                                ...
                                <div className="p-3">
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        <span className="text-lg font-bold text-bakery-primary">₹{product.price}</span>
                                        <span className={`text-xs px-2 py-1 rounded-full ${product.isAvailable ? 'bg-bakery-light text-bakery-primary' : 'bg-gray-100 text-gray-700'}`}>
