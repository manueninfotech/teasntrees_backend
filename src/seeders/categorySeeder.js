...
const categories = [
    // Hot Beverages
    { name: 'Hot Coffee', description: 'Hot coffee varieties', icon: '☕', displayOrder: 1 },
    ...
    { name: 'Lassi', description: 'Traditional lassi drinks', icon: '🥛', displayOrder: 9 },
    { name: 'Cold Pressed Juices', description: 'Fresh cold pressed juices', icon: '🧃', displayOrder: 10 },

    // Desserts & Sweets
    { name: 'Fruit Bowls', description: 'Fresh fruit bowls', icon: '🍇', displayOrder: 11 },
