...
export default function DashboardLayout() {
    ...
    const isActive = (path) => {
        return location.pathname === path || (path === `/${b}` && location.pathname === `/${b}/`);
    };
            ...
            <aside className="w-80 bg-white border-r border-gray-100 my-5 ml-5 rounded-[2.5rem] shadow-2xl shadow-gray-200/50 flex flex-col h-[calc(100vh-40px)] sticky top-5 overflow-hidden z-20">
                ...
                <div className="p-8 border-b border-gray-50 bg-white">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        />
                        <p className="text-[10px] font-black text-bakery-primary font-playfair uppercase tracking-[0.25em]">Manager Dashboard</p>
                    </div>
                </div>
                        ...
                        return (
                            <Link
                                ...
                                className={`
                                    ...
                                    ${active
                                        ? 'bg-bakery-primary text-white shadow-xl shadow-bakery-primary/20 scale-[1.02]'
